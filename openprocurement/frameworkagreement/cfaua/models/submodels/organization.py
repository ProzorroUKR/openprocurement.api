...
from openprocurement.frameworkagreement.cfaua.models.submodels.contactpoint import ContactPoint
from openprocurement.frameworkagreement.cfaua.models.submodels.identifier import Identifier
