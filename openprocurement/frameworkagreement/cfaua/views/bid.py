...
from openprocurement.frameworkagreement.cfaua.validation import validate_view_bids_in_active_tendering

@optendersresource(name='closeFrameworkAgreementUA:Tender Bids',
