...
from openprocurement.frameworkagreement.cfaua.views.award_complaint_document import TenderEUAwardComplaintDocumentResource
from openprocurement.frameworkagreement.cfaua.utils import qualifications_resource
from openprocurement.tender.openua.constants import STATUS4ROLE


@qualifications_resource(name='closeFrameworkAgreementUA:Tender Qualification Complaint Documents',
