...
from openprocurement.frameworkagreement.cfaua.views.award_complaint import (
...
@qualifications_resource(name='closeFrameworkAgreementUA:Tender Qualification Complaints',
