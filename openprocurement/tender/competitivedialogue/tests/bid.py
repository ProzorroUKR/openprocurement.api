...
class TenderBidResourceTest(BaseCompetitiveDialogEUContentWebTest):
...
# class TenderBidFeaturesResourceTest(BaseCompetitiveDialogEUContentWebTest):
...
#
#
# class TenderBidDocumentResourceTest(BaseCompetitiveDialogEUContentWebTest):
#     initial_auth = ('Basic', ('broker', ''))
#     initial_status = 'active.tendering'
#
#     def setUp(self):
