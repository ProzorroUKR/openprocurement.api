...
class TenderStage2UACancellationResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
...
class TenderStage2UALotCancellationResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
...
class TenderStage2UALotsCancellationResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
...
class TenderStage2UACancellationDocumentResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
