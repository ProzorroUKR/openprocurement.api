...
#
#
# class TenderLotFeatureBidderResourceTest(BaseCompetitiveDialogEUStage2ContentWebTest):
#     initial_lots = test_lots
#     initial_auth = ('Basic', ('broker', ''))
#
#     def setUp(self):
...
#
#
# class TenderLotProcessTest(BaseCompetitiveDialogEUStage2ContentWebTest):
