...
# class TenderCancellationDocumentResourceTest(BaseCompetitiveDialogUAContentWebTest):
#
#     def setUp(self):
...
# class TenderCancellationDocumentResourceTest(BaseCompetitiveDialogEUContentWebTest):
#
#     initial_auth = ('Basic', ('broker', ''))
#     def setUp(self):
