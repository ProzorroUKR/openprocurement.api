...
from openprocurement.tender.cfaua.validation import validate_document_operation_in_not_allowed_tender_status


@optendersresource(name='closeFrameworkAgreementSelectionUA:Tender Documents',
