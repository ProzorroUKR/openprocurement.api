...
from openprocurement.tender.cfaua.validation import validate_award_complaint_update_not_in_allowed_status


@optendersresource(name='closeFrameworkAgreementSelectionUA:Tender Award Complaints',
