...
class BaseTenderWebTest(BaseTWT):
    ...
    forbidden_document_actions_status = 'active.tendering'  # status, in which operations with tender documents (adding, updating) are forbidden
    forbidden_question_actions_status = 'active.tendering'  # status, in which updating tender questions is forbidden
    status_that_denies_get_post_patch_auction = 'active.tendering'  # status, in which operations with tender auction (getting auction info, reporting auction results, updating auction urls) and adding tender documents are forbidden
    status_that_denies_delete_create_patch_lots = 'active.tendering'  # status, in which operations with tender lots (adding, updating, deleting) are forbidden
    status_that_denies_put_create_patch_contract_docs = 'unsuccessful'  # status, in which operations with tender's contract documents (adding, updating) are forbidden
    status_that_denies_get_post_patch_auction_document = 'active.tendering'  # status, in which adding document to tender auction is forbidden
