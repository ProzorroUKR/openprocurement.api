...
class TenderUAResourceTest(BaseTenderUAWebTest):
    ...
    def test_create_tender_generated(self):
        ...
        self.assertEqual(set(tender), set([ u'procurementMethodType',  u'magicUnicorns', u'id', u'dateModified', u'tenderID', u'status', u'enquiryPeriod',
...
class TenderUAProcessTest(BaseTenderUAWebTest):
    ...
    def test_one_valid_bid_tender_ua(self):
        ...
        #self.app.authorization = ('Basic', ('broker', ''))
        #response = self.app.delete('/tenders/{}/bids/{}'.format(tender_id, bid_id))
        #response = self.app.delete('/tenders/{}/bids/{}?acc_token={}'.format(tender_id, bid_id, owner_token))
