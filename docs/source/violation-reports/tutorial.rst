...
Опублікувати звіт про порушення можна змінивши статус


.. http:example:: http/01-06-publish-report-draft.http
   :code:
...
Опублікуйте заяву, щоб вона з’явилася у стрічці змін
