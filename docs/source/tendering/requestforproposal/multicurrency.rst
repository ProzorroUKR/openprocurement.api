...
* Значення Валюта для кожної ціни за одиницю має відповідати значенню Валюта для загальної ціни пропозиції

* Загальна вартість цін за одиницю на рівні лоту може НЕ дорівнювати загальній ціні пропозиції

* Значення ПДВ у ціні за одиницю повинно мати значення False
