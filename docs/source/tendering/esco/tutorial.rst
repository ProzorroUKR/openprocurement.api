...
Набір можливих значень `procuringEntity.kind` для `esco`
--------------------------------------------------------
...
Також немає можливості встановити ``enquiryPeriod``, значення буде встановлене автоматично.
...
Для того, щоб ESCO процедура відбулась, необхідно хоча б два учасника, тобто хоча б дві пропозиції повинні бути зареєстровані до початку аукціону:
...
Для ESCO процедури необхідна кваліфікація значень пропозицій.
...
Е-Контрактінгом недоступний для `esco` закупівель.
