...
Особливість відкритих торгів в тому, що ``procurementMethodType`` було змінено з ``belowThreshold`` на ``aboveThreshold``.  Також тут неможливо встановити ``enquiryPeriod``, бо він буде призначений автоматично.
...
3. Проходження періоду оскарження(триває 4 дня)
...
якщо період оскарження(триває 4 дня) скінчився та не було ніяких скарг на скасування закупівлі або скарги були скасовані, то скасування автоматично змінює статус на `active`.
