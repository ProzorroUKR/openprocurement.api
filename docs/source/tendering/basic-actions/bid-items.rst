...
Процедури з продуктом у предметі закупівлі
------------------------------------------

Продукт в предметі закупівлі пропозиції доступний у таких процедурах:
 - aboveThresholdUA
 - aboveThresholdEU
 - belowThreshold
...
Для limited процедур продукт доступний в предметі закупівлі в самій процедурі (`tender.items`).


Створення пропозиції з продуктом у предметі закупівлі
-----------------------------------------------------

Все що вам потрібно, це вказати ідентифікатор активного продукту з маркету в полі `product` у bid.items.


Якщо ви спробуєте передати неіснуючий ідентифікатор, ви отримаєте помилку:
...
Отже, якщо всі правила дотримані, ви можете створити пропозицію з продуктом у предметі закупівлі:
