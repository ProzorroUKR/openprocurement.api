...
.. include:: http/criteria/qualification-create-requirement-response.http
   :code:

You can create requirement responses in one request with qualification patch.

.. include:: http/criteria/add-requirement-response-from-qualification.http
   :code:
...
.. include:: http/criteria/qualification-update-requirement-response.http
   :code:
...
.. include:: http/criteria/patch-requirement-response-from-qualification.http
   :code:
...
.. include:: http/criteria/qualification-requirement-response-list.http
   :code:

.. include:: http/criteria/qualification-requirement-response.http
   :code:
...
.. include:: http/criteria/qualification-delete-requirement-response.http
   :code:
...
.. include:: http/criteria/qualification-create-requirement-response-evidence.http
   :code:
...
.. include:: http/criteria/qualification-update-requirement-response-evidence.http
   :code:

Get Requirement Response Evidence
"""""""""""""""""""""""""""""""""

.. include:: http/criteria/qualification-requirement-response-evidence-list.http
   :code:

.. include:: http/criteria/qualification-requirement-response-evidence.http
   :code:

Delete Requirement Response Evidence
""""""""""""""""""""""""""""""""""""

.. include:: http/criteria/qualification-delete-requirement-response-evidence.http
   :code:
