...
.. include:: ../belowthreshold/http/tutorial/tender-post-attempt-json-data.http
   :code:
...
.. include:: ../belowthreshold/http/tutorial/tender-post-2pc.http
   :code:
...
.. include:: ../belowthreshold/http/tutorial/tender-patch-2pc.http
   :code:
...
.. include:: ../belowthreshold/http/tutorial/tender-post-attempt-json.http
   :code:
