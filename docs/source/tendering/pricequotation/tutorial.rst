...
Перед активацією тендера необхідно обов'язково додати файл підпису.

.. note::

    При проведенні закупівлі PQ організацією, що не є Замовником в розумінні закону (kind:other), використання підпису при оголошенні закупівлі не є обов'язковим.

Якщо такого документу нема, під час активації буде помилка:
...
.. note::
    ...
    При проведенні закупівлі PQ організацією, що не є Замовником в розумінні закону (kind:other), використання підпису перед прийняттям рішення по переможцю не є обов'язковим.
...
При відхилені аварду необхідно обов'язково додати файл підпису до аварду. Якщо такого документу нема, під час відхилення буде помилка:
...
.. note::
    ...
    При проведенні закупівлі PQ організацією, що не є Замовником в розумінні закону (kind:other), використання підпису при відхилені аварду по переможцю не є обов'язковим.

Додамо підпис:

.. http:example:: http/award-add-notice-document-for-unsuccessful.http
   :code:
...
Перед активацією запиту на скасування закупівлі необхідно додати файл підпису до `cancellation`.

.. note::

    При проведенні закупівлі PQ організацією, що не є Замовником в розумінні закону (kind:other), використання підпису під час активації скасування не є обов'язковим.

Якщо нема файлу підпису під час активації скасування, ми побачимо помилку:
