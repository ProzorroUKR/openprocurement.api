...
.. httpexample:: http/tutorial/create-tender-negotiation-procuringEntity.http
   :code:
...
.. httpexample:: http/tutorial/create-tender-negotiation-quick-procuringEntity.http
   :code:
...
.. httpexample:: http/tutorial/active-tender-listing-after-procuringEntity.http
   :code:
...
.. httpexample:: http/tutorial/update-tender-notice.http
   :code:
...
.. httpexample:: http/tutorial/tender-award.http
   :code:

Procuring entity registers supplier information for **negotiation** procedure:

.. httpexample:: http/tutorial/tender-negotiation-award.http
   :code:
...
.. httpexample:: http/tutorial/tender-negotiation-quick-award.http
   :code:
...
.. httpexample:: http/tutorial/tender-award-upload-document.http
   :code:
...
.. httpexample:: http/tutorial/tender-award-get-documents.http
   :code:

We can add another award document:

.. httpexample:: http/tutorial/tender-award-upload-second-document.http
   :code:
...
.. httpexample:: http/tutorial/tender-award-get-documents-again.http
   :code:
...
.. httpexample:: http/tutorial/tender-award-approve.http
   :code:

Award confirmation for **negotiation** procedure:

.. httpexample:: http/tutorial/tender-negotiation-award-approve.http
   :code:
...
.. httpexample:: http/tutorial/tender-negotiation-quick-award-approve.http
   :code:
...
.. httpexample:: http/tutorial/tender-contract-set-contract_items_unit-value.http
   :code:
...
.. httpexample:: http/tutorial/tender-contract_items_unit_value.http
   :code:
...
.. httpexample:: http/tutorial/tender-negotiation-contract-sign.http
   :code:

**Negotiation.quick** tender contract can be registered after the stand-still (5 day period after the award confirmation):

.. httpexample:: http/tutorial/tender-negotiation-quick-contract-sign.http
   :code:
...
.. httpexample::  http/tutorial/negotiation-prepare-cancellation.http
   :code:

You can change ``reasonType`` value to any of the above.

.. httpexample::  http/tutorial/negotiation-update-cancellation-reasonType.http
   :code:
