...
Later, when agreement is created, `hasItems` field will be transferred to agreement:

.. http:example:: http/has-items-false-without-items-agreement.http
   :code:
...
Later, when agreement is created, `hasItems` field will be transferred to agreement config and items will be transferred to agreement:
