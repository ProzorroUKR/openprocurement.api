...
Замовник може :ref:`відмінити своє рішення про переможця<contracting_tutorial_cancelling_award>`
...
.. _authorization-from-different-platforms-new:
...
Токен може геннеруватися декілька разів!