...
:awardCriteria:
   ...
   :`lowestCost`:
       Найнижча ціна (за замовчуванням)
   :`lifeCycleCost`:
...
:awardCriteriaDetails:
   ...
   Детальна інформація про критерії визначення переможця.

:value:
   :ref:`EstimatedValue`, обов’язково
...
:submissionMethod:
   ...
   Метод подання пропозицій.

:submissionMethodDetails:
   рядок, багатомовний

   Детальна інформація про метод подання.

:eligibilityCriteria:
   рядок, багатомовний

   Опис критеріїв відповідності для потенційних учасників.
...
:minimalStep:
   :ref:`EstimatedValue`, обов'язково для безлотових закупівель з аукціоном
...
:complaintPeriod:
   ...
   Період оскарження умов закупівлі.
...
:criteria:
   Список об’єктів :ref:`Criterion`.

   Критерії кваліфікації учасників.

:inspector:
   :ref:`organization`

   Інспектор закупівлі. Може бути вказаний лише за наявності ``funders``.

:reviewRequests:
   Список об’єктів :ref:`ReviewRequest`, лише для читання
