...
Не відрізняється від :ref:`Lot`, окрім:

:value:
    Об’єкт :ref:`AmountPercentageValue`, обов’язково

    Максимально допустимий розмір винагороди управителя у відсотках. Цінові пропозиції, більші ніж ``value``, будуть відхилені.

:minimalStep:
    Об’єкт :ref:`AmountPercentageValue`, не обов’язково

    Мінімальний крок аукціону у відсотках. Правила валідації:

    * `amountPercentage` повинно бути меншим або дорівнювати `Lot.value.amountPercentage`
