...
.. httpexample:: http/cfaua/agreements-listing-0.http
   :code:
...
.. httpexample:: http/cfaua/example_agreement.http
   :code:
...
.. httpexample:: http/cfaua/agreement-view.http
   :code:
...
.. httpexample:: http/cfaua/agreement-credentials.http
   :code:

Let's view agreements.

.. httpexample:: http/cfaua/agreements-listing-1.http
   :code:
...
.. httpexample:: http/cfaua/add-agreement-change.http
   :code:
...
.. httpexample:: http/cfaua/view-agreement-change.http
   :code:

`Change` can be modified while it is in the ``pending`` status:

.. httpexample:: http/cfaua/patch-agreement-change.http
   :code:
...
.. httpexample:: http/cfaua/add-agreement-change-document.http
   :code:
...
.. httpexample:: http/cfaua/set-document-of-change.http
   :code:
...
.. httpexample:: http/cfaua/add-agreement-change-modification.http
   :code:
...
.. httpexample:: http/cfaua/agreement_preview.http
   :code:
...
.. httpexample:: http/cfaua/apply-agreement-change.http
   :code:
...
.. httpexample:: http/cfaua/view-all-agreement-changes.http
   :code:

All changes are also listed on the agreement view.

.. httpexample:: http/cfaua/view-agreement.http
   :code:
...
.. httpexample:: http/cfaua/upload-agreement-document.http
   :code:
...
.. httpexample:: http/cfaua/agreement-documents.http
   :code:

And again we can confirm that there are two documents uploaded.

.. httpexample:: http/cfaua/upload-agreement-document-2.http
   :code:

In case we made an error, we can reupload the document over the older version:

.. httpexample:: http/cfaua/upload-agreement-document-3.http
   :code:

And we can see that it is overriding the original version:

.. httpexample:: http/cfaua/get-agreement-document-3.http
   :code:
...
.. httpexample:: http/cfaua/agreement-termination.http
   :code:
