...
class TenderBelowThresholdResourceTest(BelowThresholdBaseTenderWebTest, MockWebTestMixin):
    ...
    def test_tender_contract_template_name(self):
        ...
        with open(TARGET_DIR + 'contract-template-name/set-contract-template-name-invalid.http', 'w') as self.app.file_obj:
            response = self.app.patch_json(
        ...
        with open(TARGET_DIR + 'contract-template-name/add-contract-proforma.http',
        ...
        with open(TARGET_DIR + 'contract-template-name/invalid-with-contract-proforma.http',
                  'w') as self.app.file_obj:
            response = self.app.patch_json(
                f"/tenders/{self.tender_id}?acc_token={self.tender_token}",
        ...
        with open(TARGET_DIR + 'contract-template-name/set-contract-template-name-success.http', 'w') as self.app.file_obj:
            response = self.app.patch_json(
                f"/tenders/{self.tender_id}?acc_token={self.tender_token}",
                {"data": {"contractTemplateName": "00000000-0.0002.01"}}
            )
        ...
        with open(TARGET_DIR + 'contract-template-name/set-contract-template-in-incorrect-statuese.http', 'w') as self.app.file_obj:
            response = self.app.patch_json(
                f"/tenders/{self.tender_id}?acc_token={self.tender_token}",
                {"data": {"contractTemplateName": "00000000-0.0002.01"}},
                status=422,
