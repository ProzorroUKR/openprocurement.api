...
from docs.tests.base.constants import (
    API_HOST,
    MOCK_DATETIME,
    MOCK_SEED,
    PUBLIC_API_HOST,
)
from openprocurement.violation_report.tests.conftest import event_loop, sub_app
...
def deterministic_environment():
    ...
    original_uuid4 = real_uuid.uuid4
    counter = 0
    ...
    def fake_uuid4():
        ...
        counter += 1
        return uuid.UUID(f'88888888-4444-5555-6666-{counter:012x}')

    real_uuid.uuid4 = fake_uuid4
