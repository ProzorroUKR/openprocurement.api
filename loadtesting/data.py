...
tender = {
    "data": {
        ...
        "items": [
            {
                ...
                "quantity": 5,
                "deliveryDate": {"startDate": now.isoformat(), "endDate": (now + timedelta(days=300)).isoformat()},
                "deliveryAddress": {
                    "countryName": "Україна",
                    "postalCode": "79000",
                    "region": "м. Київ",
        ...
        "enquiryPeriod": {"startDate": now.isoformat(), "endDate": (now + timedelta(seconds=20)).isoformat()},
        ...
        "tenderers": [
            {
                ...
                "contactPoint": {"email": "soleksuk@gmail.com", "name": "Сергій Олексюк", "telephone": "+380957777777"},
                "identifier": {"scheme": "UA-EDR", "id": "00137256", "uri": "http://www.sc.gov.ua/"},
                "name": "ДКП «Школяр»",
                "scale": "micro",
            }
        ],
