...
from openprocurement.api.database_async import MongodbStore, get_mongodb
from openprocurement.api.main import get_sub_app
...
def generate_doc_service_url(sub_app, doc_hash=None):
    uuid = uuid4().hex
    ...
    return "{}/{}?{}".format(sub_app.doc_storage_config.service_url, uuid, urlencode(query))
