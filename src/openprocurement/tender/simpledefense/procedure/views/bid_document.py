...
@resource(
    name="simple.defense:Tender Bid Eligibility Documents",
...
@resource(
    name="simple.defense:Tender Bid Financial Documents",
...
@resource(
    name="simple.defense:Tender Bid Qualification Documents",
