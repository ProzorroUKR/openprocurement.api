...
from openprocurement.tender.simpledefense.tests.base import test_bids, BaseSimpleDefContentWebTest
...
class TenderAwardMilestoneALPTestCase(TenderQualificationMilestoneALPMixin, BaseSimpleDefContentWebTest):
