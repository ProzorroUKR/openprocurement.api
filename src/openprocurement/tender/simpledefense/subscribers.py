...
from openprocurement.tender.simpledefense.constants import ENQUIRY_STAND_STILL_TIME, ENQUIRY_PERIOD_TIME
...
@subscriber(TenderInitializeEvent, procurementMethodType="simple.defense")
def tender_init_handler(event):
    """ initialization handler for simpledefense tenders """
    tender = event.tender
