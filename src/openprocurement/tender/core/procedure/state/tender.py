...
from openprocurement.tender.core.utils import calc_auction_end_time, calculate_tender_date
...
class TenderState(BaseShouldStartAfterMixing, TenderStateAwardingMixing, BaseState):
    min_bids_number = 2
