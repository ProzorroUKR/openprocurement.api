...
# --- CFA (closeFrameworkAgreementUA): contracts of the agreement signed after the tender ---
...
# --- CFA selection: contracts of the source agreement ---
