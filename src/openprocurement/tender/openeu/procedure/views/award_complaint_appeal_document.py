...
@resource(
    name="aboveThresholdEU:Tender Award Complaint Appeal Documents",
...
class OpenEUAwardComplaintAppealDocumentResource(BaseAwardComplaintAppealDocumentResource):
    pass
