...
class TenderUaAwardDocumentResource(TenderAwardDocumentResource):
    @json_view(
        validators=(validate_file_upload, validate_award_document, validate_accepted_complaints),
    ...
    @json_view(
        validators=(validate_file_update, validate_award_document, validate_accepted_complaints),
