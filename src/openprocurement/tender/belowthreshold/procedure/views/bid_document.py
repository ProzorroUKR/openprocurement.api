...
from openprocurement.tender.belowthreshold.procedure.models.document import PostDocument, PatchDocument, Document
...
class TenderBelowBidDocumentResource(TenderBidDocumentResource):
...
class TenderBelowBidEligibilityDocumentResource(TenderBelowBidDocumentResource):
...
class TenderBelowBidFinancialDocumentResource(TenderBelowBidDocumentResource):
    ...
    def collection_get(self):
        return super(TenderBelowBidFinancialDocumentResource, self).collection_get()
    ...
    def get(self):
        return super(TenderBelowBidFinancialDocumentResource, self).get()
...
class TenderBelowBidQualificationDocumentResource(TenderBelowBidFinancialDocumentResource):
