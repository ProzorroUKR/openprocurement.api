...
from openprocurement.tender.belowthreshold.tests.bid_blanks import (
    ...
    create_tender_bid_document_with_award_json_fail,
...
class TenderBidDocumentWithDSResourceTest(TenderBidDocumentResourceTest):
    ...
    test_create_tender_bid_document_with_award_json_fail = snitch(create_tender_bid_document_with_award_json_fail)
