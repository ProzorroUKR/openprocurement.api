...
test_tender_cdeu_stage2_data["tenderPeriod"]["startDate"] = (now + timedelta(seconds=2)).isoformat()
...
test_tender_cdua_stage2_data["tenderPeriod"]["startDate"] = (now + timedelta(seconds=2)).isoformat()
