...
test_tender_co_short_data["tenderPeriod"] = {"endDate": (now + timedelta(days=8)).isoformat()}
...
test_tender_co_short_features_data["tenderPeriod"] = {"endDate": (now + timedelta(days=8)).isoformat()}
...
test_tender_co_short_no_auction["funders"][0]["name"] = "Світовий Банк"
test_tender_co_short_no_auction["funders"][0]["name_en"] = "World Bank"
test_tender_co_short_no_auction["funders"][0]["identifier"] = {
    "id": "44000",
    "scheme": "XM-DAC",
