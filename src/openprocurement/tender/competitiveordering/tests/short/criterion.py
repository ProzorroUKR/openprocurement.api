...
class TenderCOCriteriaTest(TenderCriteriaTestMixin, BaseTenderCOShortContentWebTest):
    initial_data = test_tender_co_short_data
    initial_lots = test_tender_below_lots
    initial_status = "draft"

    required_criteria = test_tender_co_short_required_criteria_ids


class TenderCOCriteriaLccTest(BaseTenderCOShortContentWebTest):
    initial_data = test_tender_co_short_data
    initial_lots = test_tender_below_lots
    initial_status = "draft"
...
class TenderCOCriteriaRGTest(TenderCriteriaRGTestMixin, BaseTenderCOShortContentWebTest):
    initial_data = test_tender_co_short_data
    test_lots_data = test_tender_below_lots


class TenderCOCriteriaRGRequirementTest(TenderCriteriaRGRequirementTestMixin, BaseTenderCOShortContentWebTest):
    initial_data = test_tender_co_short_data
    test_lots_data = test_tender_below_lots
