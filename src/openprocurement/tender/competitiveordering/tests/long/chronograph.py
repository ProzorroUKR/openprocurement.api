...
class TenderLotSwitch0BidResourceTest(BaseTenderCOLongContentWebTest):
...
class TenderLotSwitch1BidResourceTest(BaseTenderCOLongContentWebTest):
    initial_lots = test_tender_below_lots
    initial_bids = test_tender_co_long_bids[:1]
    initial_status = "active.tendering"
    test_not_switch_to_unsuccessful_lot_1bid = snitch(not_switch_to_unsuccessful_lot_1bid)


class TenderLotSwitchAuctionResourceTest(BaseTenderCOLongContentWebTest, TenderLotSwitchAuctionResourceTestMixin):
    initial_status = "active.tendering"
    initial_lots = test_tender_below_lots
