...
from openprocurement.tender.open.tests.award import TenderAwardPendingResourceTestCase
...
class TenderBidRequirementResponseTestMixin:
    ...
    initial_criteria = test_tender_co_long_criteria
...
class CreateBidMixin:
    ...
    def setUp(self):
        super().setUp()
        bid_data = deepcopy(test_tender_co_long_bids[0])
...
class TenderBidResourceTest(BaseTenderCOLongContentWebTest, TenderBidResourceTestMixin):
    initial_data = test_tender_co_long_data
    initial_lots = test_tender_below_lots
    initial_status = "active.tendering"
    test_bids_data = test_tender_co_long_bids
...
class TenderBidDecimalResourceTest(BaseTenderCOLongContentWebTest):
    initial_data = test_tender_co_long_data
    initial_lots = test_tender_below_lots
    initial_status = "active.tendering"
    test_bids_data = test_tender_co_long_bids
...
class Tender2LotBidResourceTest(BaseTenderCOLongContentWebTest):
    initial_data = test_tender_co_long_data
    test_bids_data = test_tender_co_long_bids
...
class TenderBidFeaturesResourceTest(BaseTenderCOLongContentWebTest):
...
class TenderBidDocumentResourceTest(CreateBidMixin, TenderBidDocumentResourceTestMixin, BaseTenderCOLongContentWebTest):
    initial_status = "active.tendering"
    initial_lots = test_tender_below_lots
    test_bids_data = test_tender_co_long_bids
    author_data = test_tender_below_author
...
class TenderBidActivateDocumentTest(CreateBidMixin, BaseTenderCOLongContentWebTest):
    initial_status = "active.tendering"
    initial_lots = test_tender_below_lots
    test_bids_data = test_tender_co_long_bids
    author_data = test_tender_below_author
...
class TenderBidderBatchDocumentResourceTest(BaseTenderCOLongContentWebTest):
    initial_status = "active.tendering"
    initial_lots = test_tender_below_lots
    test_bids_data = test_tender_co_long_bids
    bid_data_wo_docs = {
...
class TenderWithDisabledValueRestriction(BaseTenderCOLongContentWebTest):
    initial_status = "active.tendering"
