...
from openprocurement.tender.competitiveordering.tests.long.award_blanks import (
...
from openprocurement.tender.competitiveordering.tests.long.base import (
    ...
    test_tender_co_long_three_bids,
)
...
from openprocurement.tender.open.tests.award_blanks import (
    ...
    patch_tender_award_unsuccessful_third,
...
class TenderAwardPendingResourceTestCase(BaseTenderCOLongContentWebTest):
    initial_status = "active.qualification"
    initial_bids = test_tender_co_long_three_bids
...
class TenderAwardQualificationResourceTest(TenderAwardPendingResourceTestCase):
    ...
    test_patch_tender_award_unsuccessful_third = snitch(patch_tender_award_unsuccessful_third)
...
class TenderAwardComplaintResourceTest(
    TenderAwardActiveResourceTestCase, TenderAwardComplaintResourceTestMixin, TenderCOAwardComplaintResourceTestMixin
):
    initial_lots = test_tender_below_lots
