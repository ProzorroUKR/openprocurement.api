...
from openprocurement.tender.belowthreshold.tests.award_blanks import (
    ...
    get_tender_award_data_for_sign,
...
class TenderAwardResourceTestMixin:
    ...
    test_get_tender_award_data_for_sign = snitch(get_tender_award_data_for_sign)
...
class TenderLotAwardCheckResourceTest(TenderContentWebTest, TenderLotAwardCheckResourceTestMixin):
    ...
    initial_bids.append(deepcopy(test_tender_rfp_bids[0]))
...
class TenderLotAwardResourceTest(TenderContentWebTest):
    ...
    test_award_sign_not_required = snitch(award_sign_not_required)
...
class TenderAwardComplaintDocumentResourceTest(
    ...
    def setUp(self):
        ...
        response = self.app.post_json(
            ...
            {"data": test_tender_rfp_draft_claim},
        )
