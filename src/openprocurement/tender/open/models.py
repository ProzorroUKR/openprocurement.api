...
class IAboveThresholdTender(ITender):
    """ Marker interface for aboveThreshold tenders """
...
@implementer(IAboveThresholdTender)
class Tender(BaseTender):
    ...
    procurementMethodType = StringType(default=ABOVE_THRESHOLD)
    items = ListType(
    ...
    def tender_enquiryPeriod(self):
        ...
        clarifications_until = calculate_clarif_business_date(end_date, ENQUIRY_STAND_STILL_TIME, self)
