...
def post_tender_bid_with_enabled_lot_values_restriction(self):
    lots = self.mongodb.tenders.get(self.tender_id).get("lots")
...
def patch_tender_bid_with_enabled_lot_values_restriction(self):
    lots = self.mongodb.tenders.get(self.tender_id).get("lots")
...
def post_tender_bid_with_disabled_exceeded_value(self):
    response = self.app.post_json(
        f"/tenders/{self.tender_id}/bids",
        {"data": {
            "selfQualified": True,
...
def patch_tender_bid_with_disabled_exceeded_value(self):
    response = self.app.post_json(
        f"/tenders/{self.tender_id}/bids",
        {"data": {
            "selfQualified": True,
