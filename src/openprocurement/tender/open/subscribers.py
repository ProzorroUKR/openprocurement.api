...
from openprocurement.tender.open.constants import ENQUIRY_PERIOD_TIME, ENQUIRY_STAND_STILL_TIME, ABOVE_THRESHOLD


@subscriber(TenderInitializeEvent, procurementMethodType=ABOVE_THRESHOLD)
