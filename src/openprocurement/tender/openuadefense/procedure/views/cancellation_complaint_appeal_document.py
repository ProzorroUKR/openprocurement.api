...
@resource(
    name=f"{ABOVE_THRESHOLD_UA_DEFENSE}:Tender Cancellation Complaint Appeal Documents",
...
class OpenUADefenseCancellationComplaintAppealDocumentResource(BaseCancellationComplaintAppealDocumentResource):
    pass
