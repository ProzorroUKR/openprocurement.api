...
@resource(
    name="aboveThresholdUA.defense:Tender Bid Eligibility Documents",
...
@resource(
    name="aboveThresholdUA.defense:Tender Bid Financial Documents",
...
@resource(
    name="aboveThresholdUA.defense:Tender Bid Qualification Documents",
