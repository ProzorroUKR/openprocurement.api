...
from openprocurement.tender.cfaua.procedure.state.award_claim import (
    CFAUAAwardClaimState,
)
from openprocurement.tender.cfaua.procedure.state.award_complaint import (
    CFAUAAwardComplaintState,
)
