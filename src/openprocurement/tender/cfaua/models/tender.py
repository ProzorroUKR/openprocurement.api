...
from openprocurement.api.models import (
    Period, ListType, SifterListType, plain_role, IsoDurationType
)
...
class CloseFrameworkAgreementUA(Tender):
    ...
    lots = ListType(ModelType(Lot, required=True), min_size=1, max_size=1, default=list(), validators=[validate_lots_uniq])
