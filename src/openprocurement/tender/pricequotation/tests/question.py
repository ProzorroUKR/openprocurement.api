...
from openprocurement.tender.pricequotation.tests.base import TenderContentWebTest, test_lots, test_author
from openprocurement.tender.pricequotation.tests.question_blanks import (
