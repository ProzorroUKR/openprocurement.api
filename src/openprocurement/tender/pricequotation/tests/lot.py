...
from openprocurement.tender.pricequotation.tests.base import BaseTenderWebTest, TenderContentWebTest, test_lots
from openprocurement.tender.pricequotation.tests.lot_blanks import (
