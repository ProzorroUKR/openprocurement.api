...
from openprocurement.tender.arma.tests.bid_blanks import (
...
class Tender2LotBidResourceTest(BaseTenderContentWebTest):
    ...
    initial_lots = 3 * test_tender_arma_lots
    initial_status = "active.tendering"
    initial_criteria = test_tender_arma_criteria
...
def suite():
    ...
    suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(Tender2LotBidResourceTest))
