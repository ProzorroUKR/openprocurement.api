...
def get_tender_auction(self):
    ...
    self.assertEqual(auction['bids'][0]['lotValues'][0]['relatedLot'],
    ...
    self.assertEqual(auction['bids'][1]['lotValues'][0]['relatedLot'],
                     self.initial_bids[1]['lotValues'][0]['relatedLot'])
    ...
    for lot in self.initial_lots:
        for bid in patch_data['bids']:
            bid['lotValues'].append({
                "relatedLot": lot['id'],
                "participationUrl":
                    u'http://auction-sandbox.openprocurement.org/tenders/{}_{}?key_for_bid={}'.format(self.tender_id,
                        lot['id'], self.initial_bids[0]['id']
                    )
            })
        patch_data['lots'].append({
            'auctionUrl': u'http://auction-sandbox.openprocurement.org/tenders/{}_{}'.format(self.tender_id, lot['id'])
        })
