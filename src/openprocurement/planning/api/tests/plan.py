...
from openprocurement.planning.api.tests.plan_blanks import (  # PlanTest; AccreditationPlanTest; PlanResourceTest; PlanBudgetBreakdownTest; PlanResourceBeforeBudgetPeriodTest; Plan Buyers
    ...
    plan_item_uktzed_classification,
    plan_not_found,
    plan_rationale,
    plan_root_uktzed_forbidden,
    plan_token_invalid,
)
...
class PlanResourceTest(BasePlanTest):
    ...
    test_create_plan_remove_field = snitch(create_plan_remove_field)
    test_patch_plan_remove_field = snitch(patch_plan_remove_field)
    ...
    test_plan_item_uktzed_classification = snitch(plan_item_uktzed_classification)
    test_plan_root_uktzed_forbidden = snitch(plan_root_uktzed_forbidden)
