from openprocurement.api.utils import json_view, set_ownership, generate_id, context_unpack, get_now
...
from openprocurement.agreement.core.resource import AgreementsResource, agreements_resource


@agreements_resource(name="Agreements", path="/agreements")
