...
REQUIRED_DELIVERY_AND_FINANCING_MILESTONES_VALIDATION_FROM = get_constant(
    CONSTANTS_CONFIG, "REQUIRED_DELIVERY_AND_FINANCING_MILESTONES_VALIDATION_FROM"
)
...
# CS-21722
ITEMS_UNIT_VALUE_AMOUNT_VAT_AWARE_VALIDATION_FROM = get_constant(
    CONSTANTS_CONFIG, "ITEMS_UNIT_VALUE_AMOUNT_VAT_AWARE_VALIDATION_FROM"
)

TENDER_ITEMS_UNIT_VALUE_VALIDATION_FROM = get_constant(CONSTANTS_CONFIG, "TENDER_ITEMS_UNIT_VALUE_VALIDATION_FROM")
...
# CS-21518
EST_VALUE_VAT_NOT_INCLUDED_VALIDATION_FROM = get_constant(
    CONSTANTS_CONFIG,
    "EST_VALUE_VAT_NOT_INCLUDED_VALIDATION_FROM",
)

# CS-22385
NEGOTIATION_VAT_NOT_INCLUDED_VALIDATION_FROM = get_constant(
    CONSTANTS_CONFIG,
    "NEGOTIATION_VAT_NOT_INCLUDED_VALIDATION_FROM",
)

# CS-21844
ARMA_MIN_EXPECTED_INCOME_FROM = get_constant(CONSTANTS_CONFIG, "ARMA_MIN_EXPECTED_INCOME_FROM")

# CS-22145
NO_LOCALIZATION_CANCELLATION_REASON_FROM = get_constant(
    CONSTANTS_CONFIG,
    "NO_LOCALIZATION_CANCELLATION_REASON_FROM",
)

# CS-22262
TENDER_ITEMS_DIFFERENT_CPV_FROM = get_constant(CONSTANTS_CONFIG, "TENDER_ITEMS_DIFFERENT_CPV_FROM")
