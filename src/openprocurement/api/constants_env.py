...
PROCUREMENT_ENTITY_KIND_VALIDATION_FROM = get_constant(
    CONSTANTS_CONFIG,
    "PROCUREMENT_ENTITY_KIND_VALIDATION_FROM",
)
...
# CS-20939
CANCELLATION_REPORT_DOC_REQUIRED_FROM = get_constant(CONSTANTS_CONFIG, "CANCELLATION_REPORT_DOC_REQUIRED_FROM")
...
# CS-20541
PRODUCT_CATEGORY_VALIDATION_FROM = get_constant(CONSTANTS_CONFIG, "PRODUCT_CATEGORY_VALIDATION_FROM")

# CS-20657
CONTRACT_CHANGE_RATIONALE_TYPES_SET_FROM = get_constant(
    CONSTANTS_CONFIG,
