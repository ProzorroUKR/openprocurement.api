...
# CS-21279
CAUSE_DETAILS_URI_REQUIRED_FROM = get_constant(CONSTANTS_CONFIG, "CAUSE_DETAILS_URI_REQUIRED_FROM")
...
# CS-21494
MARKET_CRITERIA_EXPECTED_MIN_MAX_ITEMS_CHANGE_ALLOWED_FROM = get_constant(
    CONSTANTS_CONFIG,
