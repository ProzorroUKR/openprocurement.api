...
from openprocurement.api.context_async import get_request_async
...
DocumentDataT = TypeVar("DocumentDataT", bound=RequestDocument)
...
def download_file(document: Document, config: DocStorageConfig, doc_id) -> HTTPFound:
