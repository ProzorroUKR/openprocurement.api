...
SUBMISSION_MASK_MAPPING = compile_mask_mapping(SUBMISSION_MASK_MAPPING_RAW)
...
AGREEMENT_MASK_MAPPING_REPLACEMENT_RULES = {
    "$..documents": [
        "$.documents",
        "$.contracts[*].documents",
...
AGREEMENT_MASK_MAPPING_OPTIMIZED = optimize_tender_mask_mapping(
    AGREEMENT_MASK_MAPPING_RAW,
    AGREEMENT_MASK_MAPPING_REPLACEMENT_RULES,
)

AGREEMENT_MASK_MAPPING = compile_mask_mapping(AGREEMENT_MASK_MAPPING_OPTIMIZED)
